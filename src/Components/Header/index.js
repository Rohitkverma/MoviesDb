  ...
  return (
    <header className="header">
      <Navbar bg="dark" expand="lg">
        <Container>
          <Link to="/" style={{cursor:"pointer",textDecoration:"none"}}><Navbar.Brand><span>Movie</span><span style={{color:"red"}}>Db</span></Navbar.Brand></Link>
          <Navbar.Toggle aria-controls="navbarScroll" style={{border:"1px solid white" }} />
          <Navbar.Collapse id="navbarScroll">
            <Nav
              className="flex-end my-2 my-lg-0"
