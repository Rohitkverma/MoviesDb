  ...
  return (
    <>
      <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-6 mb-4">
        <Link to={`/details/${id}`} className="video-thumb font-medium shadow-lg p-2">
          ...
          <div className="video-content">
            <h3 className="name text-center">{title}</h3>
            <h3 className="name text-center" style={{ fontSize: "12px" }}>
              Rating: {vote_average}
            </h3>
          </div>
        </Link>
